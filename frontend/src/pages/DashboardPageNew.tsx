        ...
        <DashboardLayout>
            <div className="space-y-8 max-w-7xl mx-auto pb-12">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-txt-primary tracking-tight">Overview</h1>
                    ...
                    <div className="flex gap-3">
                        {isBrand ? (
                            ...
                            <Link to="/feed" className="bg-card hover:bg-input border border-border-color text-txt-primary px-5 py-2.5 rounded-lg text-sm font-semibold transition-all">
                                Find Opportunities
                            </Link>
                        )}
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {displayStats.map((stat, idx) => (
                        <motion.div
                            ...
                            className="bg-card p-6 rounded-xl border border-border-color shadow-sm hover:shadow-md transition-shadow group"
                        >
                            <div className="flex justify-between items-start mb-4">
                                <div className="p-2.5 bg-input rounded-lg text-txt-secondary group-hover:text-primary group-hover:bg-primary/5 transition-colors">
                                    {stat.icon}
                                </div>
                            ...
                            <h3 className="text-2xl font-bold text-txt-primary">{stat.value}</h3>
                            <p className="text-sm text-txt-secondary font-medium mt-1">{stat.label}</p>
                        </motion.div>
                    ))}
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-4">
                            {campaigns.length > 0 ? campaigns.map((campaign, idx) => (
                                <motion.div
                                    ...
                                    className="bg-card p-5 rounded-xl border border-border-color shadow-sm hover:border-primary/20 transition-all flex items-center justify-between group"
                                >
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 bg-input rounded-lg flex items-center justify-center text-xl text-txt-secondary group-hover:bg-primary/5 group-hover:text-primary transition-colors">
                                            <FaBriefcase />
                                        </div>
                                        <div>
                                            <h4 className="font-bold text-txt-primary group-hover:text-primary transition-colors">
                                                {campaign.title}
                                            </h4>
                                    ...
                                    <div className="text-right">
                                        <Link to={`/campaigns/${campaign._id}`} className="px-4 py-2 border border-border-color rounded-lg text-sm font-semibold text-txt-secondary hover:text-txt-primary hover:border-txt-secondary/50 transition-all">
                                            Manage
                                        </Link>
                                    </div>
                                </motion.div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-card p-5 rounded-xl border border-border-color shadow-sm">
                            <h3 className="font-bold text-sm text-txt-primary mb-4">System Status</h3>
                            <div className="space-y-3">
                                <div className="flex items-center justify-between text-sm">
                                    <span className="text-txt-secondary flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-green-500"></div> API</span>
                                    <span className="text-green-600 font-medium">Operational</span>
                                </div>
                                <div className="flex items-center justify-between text-sm">
                                    <span className="text-txt-secondary flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-green-500"></div> Payments</span>
                                    <span className="text-green-600 font-medium">Operational</span>
                                </div>
                            </div>
                        </div>
