...
const Hero = () => {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-studio-white overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <span className="text-sm font-bold tracking-widest uppercase text-gray-500">The Modern Standard</span>
                </div>
                
                <h1 className="text-6xl lg:text-8xl font-black text-onyx leading-[0.95] tracking-tight mb-8">
                    Create. <br />
                ...
                <p className="text-xl text-gray-500 max-w-lg mb-10 leading-relaxed font-medium">
                    ...
                    <span className="text-onyx font-bold"> No clutter. Just business.</span>
                </p>
                ...
                <div className="flex flex-wrap gap-4">
                    ...
                    <MagneticButton 
                        ...
                        className="px-8 py-4 bg-white text-onyx border-2 border-gray-100 rounded-full font-bold text-lg hover:border-gray-300 transition-all flex items-center gap-3"
                    >
            ...
            >
                ...
                {/* Phone Frame */}
                <div className="relative w-[300px] sm:w-[350px] aspect-[9/19] bg-studio-white rounded-[40px] border-[8px] border-gray-900 shadow-2xl overflow-hidden z-10 hover:rotate-1 transition-transform duration-500">
                    {/* Notch/Island */}
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 h-7 w-28 bg-gray-900 rounded-b-2xl z-20"></div>

                    {/* Screen Content */}
                    <div className="h-full w-full bg-white pt-12 px-5 flex flex-col font-sans">
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <div className="w-8 h-8 rounded-full border border-gray-100 flex items-center justify-center relative">
                                <span className="absolute top-0 right-0 w-2 h-2 bg-primary rounded-full animate-pulse"></span>
                                <FaBolt className="text-gray-400 text-xs" />
                            </div>
                        </div>

                        {/* Earnings Card */}
                        <div className="bg-white p-6 rounded-3xl shadow-[0_10px_30px_rgba(0,0,0,0.05)] border border-gray-50 mb-6 relative overflow-hidden group">
                           ...
                           <p className="text-gray-400 text-[10px] font-bold uppercase tracking-wider mb-2">Total Balance</p>
                           <h3 className="text-3xl font-black text-onyx tracking-tight">ETB 45.2k</h3>
                           <div className="mt-3 inline-flex items-center gap-1 text-emerald-600 text-xs font-bold bg-emerald-50 px-2 py-1 rounded-md">
                               +12% <span className="text-gray-400 font-medium">this week</span>
                           </div>
                        </div>

                        {/* Recent Activity */}
                        <p className="text-gray-900 font-bold mb-4 text-sm ml-1">Live Campaigns</p>
                        <div className="space-y-3">
                             {[1, 2, 3].map((i) => (
                                <div key={i} className="bg-white p-3 rounded-2xl flex items-center gap-3 shadow-sm border border-gray-50 hover:shadow-md transition-shadow">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="font-bold text-gray-900 text-xs truncate">Brand Collab #{i}</p>
                                        <p className="text-[10px] text-gray-400">Payment pending</p>
                                    </div>
                ...
                <motion.div 
                    ...
                    className="absolute bottom-20 -left-4 lg:-left-12 bg-white p-4 rounded-2xl shadow-xl border border-gray-50 z-20 w-[180px]"
                >
                    <div className="flex items-center gap-3 mb-3">
                         ...
                         <div>
                             ...
                             <p className="font-bold text-gray-900 text-sm">ID Verified</p>
                         </div>
                    </div>
...
const FeatureCard = ({ icon: Icon, title, desc }: { icon: any, title: string, desc: string }) => {
    return (
        <div className="group relative p-8 bg-white rounded-3xl border border-gray-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-gray-200/50 overflow-hidden">
             {/* Hover Glow Trace */}
             ...
             <div className="w-12 h-12 bg-gray-50 rounded-2xl flex items-center justify-center text-xl text-onyx mb-6 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                 <Icon />
             </div>
             <h3 className="text-xl font-bold text-onyx mb-3 group-hover:translate-x-1 transition-transform">{title}</h3>
        ...
        <section className="py-24 bg-white relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-20 max-w-2xl">
                    <h2 className="text-4xl font-black text-onyx mb-6">Built for the <br /><span className="text-primary">Creator Class.</span></h2>
                    <p className="text-xl text-gray-500">We stripped away the complexity. No agencies, no delays, no hidden fees.</p>
                </div>
    ...
    return (
        <section className="py-32 bg-white relative overflow-hidden">
             ...
             <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                 <h2 className="text-5xl md:text-7xl font-black text-onyx mb-8 tracking-tighter">
