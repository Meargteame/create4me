...
export default function CreatorsPage_New() {
  ...
  const fetchCreators = async () => {
    try {
      ...
      setStats({
        ...
        available:
          response.stats?.availableCreators || response.stats?.available || 0,
        avgRating: response.stats?.avgRating || 0,
        bookmarked:
          response.stats?.bookmarkedCount || response.stats?.bookmarked || 0,
      });
      ...
      showToastNotification(
        "Failed to load creators. Please check your connection.",
      );
      setCreators([]);
      setLoading(false);
    }
  ...
  const handleLike = async (creatorId: string) => {
    try {
      ...
      setCreators((prev) =>
        prev.map((c) =>
          c.id === creatorId ? { ...c, isLiked: !c.isLiked } : c,
        ),
      );
      ...
      showToastNotification(
        response.message ||
          (previousState ? "Creator unliked" : "Creator liked!"),
      );
    } catch (error) {
  ...
  const handleBookmark = async (creatorId: string) => {
    try {
      ...
      setCreators((prev) =>
        prev.map((c) =>
          c.id === creatorId ? { ...c, isBookmarked: newIsBookmarked } : c,
        ),
      );
      ...
      showToastNotification(
        response.message ||
          (newIsBookmarked ? "✓ Creator bookmarked!" : "✓ Bookmark removed"),
      );
    } catch (error) {
      ...
      setCreators((prev) =>
        prev.map((c) =>
          c.id === creatorId ? { ...c, isBookmarked: !c.isBookmarked } : c,
        ),
      );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex gap-6">
          ...
          >
            <div className="bg-white/80 backdrop-blur-xl border border-gray-200/80 rounded-2xl p-6 shadow-xl sticky top-28">
              <h3 className="text-lg font-bold mb-4 flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              ...
              <div className="mb-6">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent shadow-sm hover:shadow-md transition-shadow"
                  />
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-xl text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-sm hover:shadow-md transition-shadow"
                >
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="lg:hidden">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all"
                >
                  <FaFilter size={16} />
              ...
              >
                {searchQuery && (
                  <motion.div
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 rounded-lg text-sm font-medium shadow-sm"
                  >
                    <FaSearch size={12} />
              ...
              <>
                ...
                <div className="mb-4 p-3 bg-purple-50 border border-purple-200 rounded-lg">
                  <p className="text-sm font-semibold text-purple-800">
                    📋 About to render {paginatedCreators.length} creator cards
                    below
                  </p>
                </div>
                          ...
                          <div>
                            ...
                            <div className="flex items-center justify-between mb-3 pb-3 border-b border-gray-200">
                              ...
                              <span className="text-sm font-bold text-gray-900">
                                {creator.priceRange.min.toLocaleString()} -{" "}
                                {creator.priceRange.max.toLocaleString()} ETB
                              </span>
                            </div>
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="flex items-center justify-center gap-2 mb-4">
                    ...
                    <span className="text-gray-500">
                      ({selectedCreator.totalReviews} reviews)
                    </span>
                  </div>
                </div>
