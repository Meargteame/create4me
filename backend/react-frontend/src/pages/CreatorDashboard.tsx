        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                ...
                <Link
                  to="/campaign-board"
                  className="flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-semibold text-sm sm:text-base whitespace-nowrap"
                >
                  <FaRocket />
              ...
              <div className="overflow-x-auto lg:overflow-visible custom-scrollbar pb-4 -mx-4 px-4 lg:mx-0 lg:px-0">
                <div className="flex lg:grid lg:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 min-w-min lg:min-w-0">
                  <motion.div
                    ...
                    className="flex-shrink-0 w-[260px] sm:w-[280px] lg:w-auto bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-lg p-4 sm:p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
                  >
                    <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-xs sm:text-sm text-blue-100 font-medium mb-1">Total Applications</div>
                  ...
                  <motion.div
                    ...
                    className="flex-shrink-0 w-[260px] sm:w-[280px] lg:w-auto bg-gradient-to-br from-amber-500 to-amber-600 rounded-2xl shadow-lg p-4 sm:p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="p-3 bg-white/20 backdrop-blur-xl rounded-xl">
