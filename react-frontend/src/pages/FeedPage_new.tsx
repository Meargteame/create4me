...
const mockCampaigns: CampaignPost[] = [
  {
    ...
    description: 'Looking for lifestyle creators to showcase the authentic Ethiopian coffee experience. We want to highlight the traditional coffee ceremony and modern coffee culture in Ethiopia. Perfect for creators passionate about food, culture, and storytelling.',
  ...
  },
  {
    ...
    location: 'Nationwide',
    category: 'Fashion',
    requirements: ['Fashion photography', 'Brand storytelling', 'Sustainable fashion focus', '25K+ followers'],
    likes: 18,
    comments: 12,
    applications: 8,
    isLiked: true,
  ...
  },
  {
    ...
    location: 'Addis Ababa',
    category: 'Technology',
    requirements: ['Tech review content', 'Startup interviews', 'Innovation storytelling', '40K+ followers'],
    likes: 31,
    comments: 6,
    applications: 22,
    isLiked: false,
  ...
  },
  {
    ...
    description: 'Launch campaign for our new line of natural beauty products made from Ethiopian ingredients. Looking for beauty influencers to create authentic content.',
    budget: { min: 10000, max: 25000 },
    deadline: '2024-10-25',
    location: 'Addis Ababa',
    category: 'Beauty',
    requirements: ['Beauty tutorials', 'Product reviews', 'Before/after content', '30K+ followers'],
    likes: 42,
    comments: 15,
    applications: 28,
    isLiked: true,
...
export default function FeedPage() {
  ...
  const [selectedCampaign, setSelectedCampaign] = useState<CampaignPost | null>(null)
    ...
    try {
      ...
      if (response.success) {
        ...
        const transformedCampaigns = response.campaigns.map((campaign: any) => ({
          id: campaign.id,
          brand: {
            name: campaign.user?.email?.split('@')[0] || 'Brand',
            logo: '/api/placeholder/50/50',
            verified: true
          },
          title: campaign.title,
          description: campaign.description || 'No description provided',
          budget: { min: 5000, max: 20000 }, // Default values - should come from backend
          deadline: campaign.updatedAt || new Date().toISOString(),
          location: 'Ethiopia', // Default - should come from backend
          category: 'General', // Default - should come from backend
          requirements: [], // Should come from backend
          likes: 0,
          comments: 0,
          applications: 0,
          isLiked: false,
      ...
      showToastNotification('Failed to load campaigns. Please check your connection.')
      setCampaigns([])
      setLoading(false)
    }
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <p className="text-gray-700 text-center text-lg">
            Discover the latest brand campaigns • {campaigns.length} opportunities available
          </p>
        </motion.div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">{campaigns.filter(c => c.postedAt.includes('hours ago')).length}</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">
                  {Math.round(campaigns.reduce((acc, c) => acc + (c.budget.min + c.budget.max) / 2, 0) / campaigns.length).toLocaleString()} ETB
                </p>
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">{campaigns.filter(c => c.isBookmarked).length}</p>
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm sticky top-28">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-col gap-2">
                  {['all', 'lifestyle', 'fashion', 'technology', 'beauty', 'food'].map(category => (
                    <motion.button
                      key={category}
              ...
              {/* Quick Filters */}
              <div className="mb-6">
                <h4 className="text-sm font-semibold mb-3 text-gray-700">Quick Filters</h4>
                <motion.button
...
please continue with the update
          ...
          <div className="flex-1">
            ...
            {(filter !== 'all' || searchQuery) && (
              ...
              >
                ...
                {filter !== 'all' && (
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-blue-100 text-blue-700 rounded-lg text-sm font-medium">
                    <span>{filter === 'bookmarked' ? '🔖 Bookmarked' : `📁 ${filter.charAt(0).toUpperCase() + filter.slice(1)}`}</span>
                    <button
                      ...
                      <div className="p-5 bg-gradient-to-r from-blue-600/5 to-purple-600/5">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-2.5">
                            ...
                            <div>
                              <h3 className="font-bold text-sm text-gray-800">{campaign.title}</h3>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-4">
                          <div className="flex items-center gap-2 bg-gradient-to-br from-blue-50 to-blue-100/50 border border-blue-200 px-3 py-2 rounded-xl">
                            <FaDollarSign className="text-blue-600 flex-shrink-0" size={16} />
                          ...
                          <div className="flex items-center gap-2 bg-gradient-to-br from-green-50 to-green-100/50 border border-green-200 px-3 py-2 rounded-xl">
                            <FaCalendarAlt className="text-green-600 flex-shrink-0" size={16} />
                            <div>
                          ...
                          <div className="flex items-center gap-2 bg-gradient-to-br from-purple-50 to-purple-100/50 border border-purple-200 px-3 py-2 rounded-xl">
                            <FaMapMarkerAlt className="text-purple-600 flex-shrink-0" size={16} />
                            <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-2 bg-gradient-to-br from-orange-50 to-orange-100/50 border border-orange-200 px-3 py-2 rounded-xl">
                            <FaUsers className="text-orange-600 flex-shrink-0" size={16} />
                            <div>
              ...
              <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between z-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{selectedCampaign.category}</p>
                  </div>
                </div>
                <button
                  onClick={() => setShowDetailModal(false)}
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    <p className="text-lg font-bold text-gray-900">
                      {selectedCampaign.budget.min.toLocaleString()}-{selectedCampaign.budget.max.toLocaleString()} ETB
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    <p className="text-lg font-bold text-gray-900">
                      {getDaysUntilDeadline(selectedCampaign.deadline)} days left
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-6">
                      <div className="flex items-center gap-2 text-gray-600">
                        <FaHeart className={selectedCampaign.isLiked ? 'text-blue-600' : ''} size={18} />
                        <span className="font-medium">{selectedCampaign.likes} likes</span>
                      </div>
                      <div className="flex items-center gap-2 text-gray-600">
                        <FaComment size={18} />
                        <span className="font-medium">{selectedCampaign.comments} comments</span>
                      </div>
                    </div>
                    <p className="text-sm text-gray-500">Posted {selectedCampaign.postedAt}</p>
                  </div>
                </div>
      ...
      <AnimatePresence>
        {showQuickApply && applyingCampaignId && (() => {
              ...
              >
                ...
                <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-purple-600 p-6 rounded-t-3xl">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100 text-sm">{campaign.brand.name}</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setShowQuickApply(false)}
                  ...
                  <div className="bg-white/10 backdrop-blur-xl rounded-xl p-4 border border-white/20">
                    <h4 className="text-lg font-bold text-white mb-2">{campaign.title}</h4>
                    <p className="text-blue-50 text-sm line-clamp-2">{campaign.description}</p>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 border border-blue-200 rounded-xl p-3">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs text-gray-600 font-semibold">Budget Range</span>
                      </div>
                      <p className="text-lg font-bold text-gray-900">
                        ${campaign.budget.min.toLocaleString()} - ${campaign.budget.max.toLocaleString()}
                      </p>
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100/50 border border-green-200 rounded-xl p-3">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs text-gray-600 font-semibold">Deadline</span>
                      </div>
                      <p className="text-lg font-bold text-gray-900">
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 border border-purple-200 rounded-xl p-3">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs text-gray-600 font-semibold">Location</span>
                      </div>
                      <p className="text-sm font-bold text-gray-900">{campaign.location}</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 border border-orange-200 rounded-xl p-3">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs text-gray-600 font-semibold">Applicants</span>
                      </div>
                      <p className="text-lg font-bold text-gray-900">{campaign.applications}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        Why are you a good fit for this campaign? <span className="text-red-500">*</span>
                      </label>
                      <textarea
                        rows={4}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setApplicationData(prev => ({ ...prev, portfolioLink: e.target.value }))}
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => setApplicationData(prev => ({ ...prev, deliverables: e.target.value }))}
