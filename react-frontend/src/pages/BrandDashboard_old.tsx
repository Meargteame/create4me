...
import DashboardLayout, { PageHeader, Section } from '../components/layouts/DashboardLayout';
...
export default function BrandDashboard() {
  ...
  return (
    ...
    >
      ...
      {/* Old Sidebar removed - now using DashboardLayout with Sidebar component */}
          ...
          {sidebarItems.map((item) => (
            item.link ? (
              <Link
                key={item.value}
                to={item.link}
                className="flex items-center gap-3 px-4 py-3 mb-2 text-gray-700 rounded-lg hover:bg-indigo-50 hover:text-indigo-600 transition-colors"
              >
                {item.icon}
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">{applicant.campaignTitle}</p>
