...
export default function CreatorDashboard() {
  ...
  const sidebarItems: Array<{ id: string; icon: React.ReactElement; label: string; active?: boolean; link?: string; count?: number }> = [
    ...
    { id: 'portfolio', icon: <FaStar />, label: 'Portfolio', link: '/profile' },
    { id: 'earnings', icon: <FaDollarSign />, label: 'Earnings' },
    { id: 'account', icon: <FaUser />, label: 'Account Settings', link: '/account' },
  ]
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-8">
            {/* Stats Grid - Glassmorphic Design */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {/* Stat Card 1 */}
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 hover:bg-white/15 hover:border-white/30 transition-all duration-300">
                ...
                <div className="text-sm text-gray-700 font-medium mb-2">Total Applications</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 hover:bg-white/15 hover:border-white/30 transition-all duration-300">
                ...
                <div className="text-sm text-gray-700 font-medium mb-2">Pending Review</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 hover:bg-white/15 hover:border-white/30 transition-all duration-300">
                ...
                <div className="text-sm text-gray-700 font-medium mb-2">Approved</div>
                <div className="flex items-center text-xs text-green-600 font-medium">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Recent Activity - Glassmorphic Design */}
              <div className="lg:col-span-2 bg-white/10 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 overflow-hidden">
                ...
                <div className="divide-y divide-white/10">
                  {loading ? (
                    ...
                    applications.slice(0, 5).map((app) => {
                      ...
                      return (
                        <div key={app.id} className="p-6 hover:bg-white/5 transition-all duration-300">
